...
CREATE UNIQUE INDEX `agent_prompts_type_scope_idx` ON `agent_prompts` (`agent_type`,`scope`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_provider_defaults_type_scope_idx` ON `agent_provider_defaults` (`agent_type`,`scope`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_review_agents_name_scope_idx` ON `custom_review_agents` (`name`,`scope`);--> statement-breakpoint
